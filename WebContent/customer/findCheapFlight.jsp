...
<h2>Find Cheap Flights</h2><br>
  ...
  <div class="form">
 	...
 	<form id="oneWayFormId" method="post" action="findOneWayFlightResult.jsp">
		<input id="DomesticId" type="radio" name="DomesticInter" checked value="DOMESTIC"> Domestic 
		<input id="InternationalId" type="radio" name="DomesticInter"  value="INTERNATIONAL"> International <br><br>
    		<b>From:&nbsp;</b> 
		<input type="text" name="dpAirport" value="EWR"><br><br>
		<b>To: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>
		<input type="text" name="arAirport" value="LAX"><br><br>
		<b>Depart:&nbsp;</b> 
    ...
    <form id="multiCityFormId"  method="post" action="findMultiCityFlightResult.jsp">
	   	 ...
	   	 <div id="flightId2">
	    		...
	    		<b>From:&nbsp;</b> 
			<input type="text" name="dpAirport2" value="LAX"><br><br>
			<b>To: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>
			<input type="text" name="arAirport2" value="SEA"><br><br>
			<b>Depart:&nbsp;</b> 
			<input id="departCalendarId2" name="departCalendar2" type=date min="2018-04-02" max="2018-06-04" placeholder="Pick a Date"><br><br>	
	    </div>
	     <input type="submit" value="Search Now"> 
    </form>
