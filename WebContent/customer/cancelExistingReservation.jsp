...
<body>
	...
	<%
		...
		try {
			...
			out.println("<h2>Cancel an Existing Reservation: </h2>");
			out.print("<table border=1 id='cancelResrTable'>");
			out.print("<tr>");
	        ...
	        // print the result
			while(rs.next()){
			 	out.print("<form action='cancelReservation.jsp' id='cancelReservationForm' >");
				...
				out.print("<td><input type='submit' style='color: blue' value='Cancel'></td>");
				out.print("</tr>");
			}
