...
<body>
	<%
		...
		try {
			...
			strQuery = " SELECT C.firstname, C.lastname, A.email, SUM(R.total_fee) total_revenue "
					+ " FROM CUSTOMERS C, ACCOUNT A, RESERVATION R "
					+ " WHERE C.firstname = ? AND C.lastname = ? AND C.email = A.email AND A.acct_num = R.acct_num"
					+ " GROUP BY A.email;";
...
// 			System.out.println(" debuggable statement= " + stm.toString());
			...
			String queryType = "Revenue Generated by Customer '" + firstName + " " + lastName + "': ";
